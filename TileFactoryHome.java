public class TileFactoryHome extends TileFactory {
...
case 105:
 ...
 break;
case 106:
  tile = new Tile("Geenster.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
 tile.isSolid = true; 
 break;
case 107:
...
case 110:
 ...
 break;
case 111:
  tile = new Tile("Gouden_nonster.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
 tile.isSolid = true; 
 break;
case 112:
  tile = new Tile("Gouden_sterHud.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
 tile.isSolid = true; 
 break;
case 113:
...
case 115:
 ...
 break;
case 116:
  tile = new Tile("grassCenter2.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
 tile.isSolid = true; 
 break;
case 117:
...
case 149:
 ...
 break;
case 150:
  tile = new Tile("hud_gem_blueempty.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
 tile.isSolid = true; 
 break;
case 151:
...
case 159:
 ...
 break;
case 160:
  tile = new Tile("hud_keyGreen_disabled.png", TileEngine.TILE_WIDTH, TileEngine.TILE_HEIGHT);
 tile.isSolid = true; 
 break;
case 161:
